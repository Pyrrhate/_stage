<section id="home-header" class="home-page margin-xl-top">
  <div class="container">
    <div class="jumbotron">
      ...
      <h2><a class="btn btn-primary btn-warning btn-lg btn-inscription" href="#" data-toggle="modal" data-target="#signup-modal">S'inscrire</a></h2>
    </div>
  </div>

<?php require_once('includes/modal-sign-up.php'); ?>
