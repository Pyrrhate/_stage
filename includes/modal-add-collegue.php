<!-- modal Add Collegue -->
<div class="modal fade" id="add-collegue-modal" tabindex="-1" role="dialog" aria-labelledby="edit collegue" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        <h1 class="modal-title text-center">Ajouter un traducteur</h1>

      </div>
      <div class="modal-body">
        <form role="form" id="form-collegue">
